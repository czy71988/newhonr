  ...
  <div class="honrmima">
    ...
    <div class="content9">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  class="demo-ruleForm">
        ...
        <el-form-item label="请输入新密码" prop="name3" show-password>
          <el-input v-model="ruleForm.name3" show-password></el-input>
        </el-form-item>
        <el-form-item label="再次输入新密码" prop="name4" show-password>
...
<script>
// import { xiugaimimaL } from '../../api/login'
...
export default {
  ...
  methods: {
    countDown () {
      this.$axios.get('/zkurtg-red-api/public/captchaImageByPhone?phone=' + this.phone).then((response) => {
